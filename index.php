	...
	<section class="container">
		<div class="card card-outline-info">
			<div class="card-block">
				<div class="card-solo"><img class="card-img-top" src="http://img.youtube.com/vi/ozwgqkGubFo/mqdefault.jpg" id="Quote Zoom" title="Video Presentation - Quote Zoom" title="Video Presentation - Quote Zoom" alt="Video Presentation - Quote Zoom">
				</div>
	...
	<section class="container">
		<div class="card">
			...
			<div class="card-footer">
				<div class="m-auto">
					<img id="img-marketing" src="http://bestwhiteboardvideo.com/wp-content/uploads/wp_image_duplicator_uploads/Live Spokespeople.jpg" class="img-fluid rounded mx-auto d-block" alt="Our Spokespeople"/>
				</div>
			</div>
		</div>
	</section>
