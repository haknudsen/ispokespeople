...
<div class="container card-group my-3" id="spokesperson_videos">
  <div class="card card-outline-info">
    <div class="card-block"> <img class="card-img-top" src="https://websitetalkingheads.com/images/WebsiteVideo.gif" alt="Custom Video Player" title="Custom Video Player"/>
  ...
  <div class="card card-outline-info">
    <div class="card-block"> <img class="card-img-top" src="https://websitetalkingheads.com/images/YouTubeReady.gif" title="YouTube Ready Video" alt="YouTube Ready Video"/>
...
<section class="container">
  <div class="card card-outline-info">
    <div class="card-block">
      <div class="card-solo"><img class="card-img-top" src="http://img.youtube.com/vi/ozwgqkGubFo/mqdefault.jpg" id="Quote Zoom" title="Video Presentation - Quote Zoom" title="Video Presentation - Quote Zoom" alt="Video Presentation - Quote Zoom"> </div>
...
<div id="embed-scratchcard-5LpQX6aP1X"><link rel="stylesheet" href="//vidscratch.com/app/public/scratchcard.css"><script type="text/javascript" src="//vidscratch.com/app/public/jquery-3.4.1.min.js"></script><script type="text/javascript" id="cardjs-5LpQX6aP1X" src="//vidscratch.com/app/public/scratchcard.js"></script><iframe id="scratchcard-frame-5LpQX6aP1X" name="scratchcard-frame-5LpQX6aP1X" class="exit-popup scratchcardframe" scrolling="no" src="//vidscratch.com/app/api/embed-game/OTYy/MTI1NTE=/exit-popup" frameborder="0" allowfullscreen="" style="height: 360px;width:300px;display:none;"></iframe><div class="exit-popup-backcover" id="scratcard_backcover"></div></div>
</section>
